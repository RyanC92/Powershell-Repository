...
@{
    ...
    FunctionsToExport     = @('Get-Blank','Get-Karma','Get-PSKoan','Get-PSKoanLocation','Get-PSKoanSetting','Register-Advice','Reset-PSKoan','Set-PSKoanLocation','Set-PSKoanSetting','Show-Advice','Show-Karma','Update-PSKoan')
