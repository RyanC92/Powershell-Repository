...
@{
    ...
    FunctionsToExport     = @('Get-Blank','Get-Karma','Get-PSKoan','Get-PSKoanLocation','Get-PSKoanSetting','Move-PSKoanLibrary','Register-Advice','Reset-PSKoan','Set-PSKoanLocation','Set-PSKoanSetting','Show-Advice','Show-Karma','Update-PSKoan')
