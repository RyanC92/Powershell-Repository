...
$OU = Read-Host "Please enter the OU that you want to work on (copy and paste it from AD, Example: OU=Computers,OU=Pittsburgh,OU=North Central,OU=Offices,DC=tcco,DC=org" 
